# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-03-11 09:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default=instagram.models.generate_id, max_length=10, unique=True)),
        ...
        migrations.AddField(
            model_name='like',
            name='posts',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='liked_post', to='instagram.Posts'),
        ),
        migrations.AddField(
            model_name='like',
            name='user',
